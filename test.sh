...
mkdir ~/dbt-projects && cd ~/dbt-projects && python3 -m venv env && source env/bin/activate && pip install dbt-core dbt-snowflake dbt-databricks dbt-bigquery dbt-redshift
